...
namespace BonusMarket.Admin.Models.Brand
{
    public class BrandVm
    {
        ...
        public PagedResult<Shared.Models.Core.Brand> List { get; set; }
        public bool IsEmpty()
        {
            return String.IsNullOrEmpty(SearchType);
        }
        
        public Shared.Models.Core.Brand ParentBrand { get; set; } 
        ...
        public BrandVm()
        {
            List = new PagedResult<Shared.Models.Core.Brand>();
        }
        public BrandVm(PagedResult<Shared.Models.Core.Brand> list)
        {
            List = list;
        }
        ...
        public void FromFilter(BrandFilter filter)
        {
